package com.nanyou.monitor;

import com.nanyou.exception.ServerInternalErrorException;
...
public class ServiceMonitor {
     ...
     * under that.
     */
    @Pointcut("execution(* com.nanyou.web.service..*(..))")
     ...
     */
    @AfterThrowing(pointcut = "com.nanyou.monitor.ServiceMonitor.serviceLayer()", throwing = "e")
